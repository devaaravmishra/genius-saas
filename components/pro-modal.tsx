			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription className="text-center pt-2 space-y-2 text-zinc-900 font-medium">
						...
						<Card key={"cloud"} className="p-3 border-black/5 flex items-center justify-between">
							<div className="flex items-center gap-x-4">
								<div className={cn("p-2 w-fit rounded-md", "bg-blue-700/10")}>
									<Cloud className={cn("w-6 h-6", "text-blue-700")} />
								</div>
